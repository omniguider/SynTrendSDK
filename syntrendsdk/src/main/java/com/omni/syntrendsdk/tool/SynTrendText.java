...
public class SynTrendText {

    public static final boolean isTestMode = false;

    public static final double START_LOCATION_LAT = 24.127153682922;
    public static final double START_LOCATION_LNG = 120.67067900835;

    public static final String NLPI_1F_FLOOR_PLAN_ID = "d9124475-d2bb-42fb-9489-b9ad34746032";
